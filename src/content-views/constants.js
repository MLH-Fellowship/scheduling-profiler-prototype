...
export const COLORS = Object.freeze({
  ...
  REACT_COMMIT: '#f8df70',
  REACT_COMMIT_SELECTED: '#f8df72',
  REACT_COMMIT_HOVER: '#fcd217',
  REACT_LAYOUT_EFFECTS: '#c49edd',
  REACT_LAYOUT_EFFECTS_SELECTED: '#934FC1',
  REACT_LAYOUT_EFFECTS_HOVER: '#7C1ABE',
  REACT_PASSIVE_EFFECTS: '#c49edd',
  REACT_PASSIVE_EFFECTS_SELECTED: '#934FC1',
  REACT_PASSIVE_EFFECTS_HOVER: '#7C1ABE',
  REACT_SCHEDULE: '#9fc3f3',
  REACT_SCHEDULE_HOVER: '#298ff6',
  REACT_SCHEDULE_CASCADING: '#f8df70',
  REACT_SCHEDULE_CASCADING_HOVER: '#fcd217',
